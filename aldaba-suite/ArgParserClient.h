...
#ifndef _ALDABAPARSERCLIENT_H_
#define _ALDABAPARSERCLIENT_H_ 1
...
class ArgParserClient : public ArgParser {

  public:

    ArgParserClient();
    ~ArgParserClient();
    static int parse_arguments(int argc, char *argv[], ClientOps *opt);
