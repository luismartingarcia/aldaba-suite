...
#ifndef __PKDATASTRONG6_H__
#define __PKDATASTRONG6_H__ 1

#include "ApplicationLayerElement.h"
#include "IPAddress.h"

#define PK_STRONG_IPv6_DATA_LEN 48
#define PK_STRONG_IPv6_NONCE_LEN 10
#define PK_STRONG_IPv6_MAC_LEN 16
...
class PKDataStrong6 : public ApplicationLayerElement {

    private:
        
        struct pk_strong_header_ipv6{
            u8 nonce[PK_STRONG_IPv6_NONCE_LEN];
            u16 knock_port;
            u32 timestamp;
            struct in6_addr knock_ip;
            u8 mac[PK_STRONG_IPv6_MAC_LEN];
        }__attribute__((__packed__));

        typedef struct pk_strong_header_ipv6 pk_strong_header_ipv6_t;
        
        pk_strong_header_ipv6_t h;
